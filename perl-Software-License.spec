...
%prep
%setup -q -n Software-License-0.104005
cd %{_builddir}/Software-License-0.104005
pushd ..
cp -a Software-License-0.104005 buildavx2
popd
...
cp %{_builddir}/Software-License-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Software-License/e2033a51f7e597a6946bd3b42a918795a2a155cc || :
cp %{_builddir}/Software-License-%{version}/lib/Software/License.pm %{buildroot}/usr/share/package-licenses/perl-Software-License/b13c7c56ed5709eba8d2a9e55d5eacf1facf5098 || :
cp %{_builddir}/Software-License-%{version}/lib/Software/LicenseUtils.pm %{buildroot}/usr/share/package-licenses/perl-Software-License/35b93c8c5b2084007bcfcf3a831fe3a0b6efe841 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Software-License/35b93c8c5b2084007bcfcf3a831fe3a0b6efe841
/usr/share/package-licenses/perl-Software-License/b13c7c56ed5709eba8d2a9e55d5eacf1facf5098
/usr/share/package-licenses/perl-Software-License/e2033a51f7e597a6946bd3b42a918795a2a155cc
